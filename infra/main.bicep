param webapiName string = 'apiezzy' // Keep this param as is, it's used for the resource name
...
module webapp 'br/public:avm/res/web/static-site:0.7.0' = {
  ...
  params: {
    ...
    tags: union(tags, { 'azd-service-name': webappName }) // This is correct if your azure.yaml service name is 'webapp'
    sku: 'Standard'
  }
}
...
module webapi 'br/public:avm/res/web/site:0.15.1' = {
  ...
  params: {
    kind: 'app'
    name: webapiName
    tags: union(tags, { 'azd-service-name': 'webapi' }) // <--- THIS IS THE REQUIRED CHANGE
